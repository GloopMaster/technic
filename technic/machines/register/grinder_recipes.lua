...
register_dust("Akalin",          "gloopores:akalin_ingot")
register_dust("Alatro",          "gloopores:alatro_ingot")
register_dust("Arol",            "gloopores:arol_ingot")
...
register_dust("Talinite",        "gloopores:talinite_ingot")
